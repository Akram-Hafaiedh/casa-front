    ...
    return (
        <div className="container-fixed">
            ...
            <div className="flex flex-col gap-2.5" data-tabs="true">
                <a href="#" data-tab-toggle="#activity_2024"
                    className="btn btn-sm text-gray-600 hover:text-primary tab-active:bg-primary-light tab-active:text-primary ">
                    2024
                </a>
                <a href="#" data-tab-toggle="#activity_2023"
                    className="btn btn-sm text-gray-600 hover:text-primary tab-active:bg-primary-light tab-active:text-primary ">
                    2023
                </a>
                <a href="#" data-tab-toggle="#activity_2022"
                    className="btn btn-sm text-gray-600 hover:text-primary tab-active:bg-primary-light tab-active:text-primary ">
                    2022
                </a>
                <a href="#" data-tab-toggle="#activity_2021"
                    className="btn btn-sm text-gray-600 hover:text-primary tab-active:bg-primary-light tab-active:text-primary ">
                    2021
                </a>
                <a href="#" data-tab-toggle="#activity_2020"
                    className="btn btn-sm text-gray-600 hover:text-primary tab-active:bg-primary-light tab-active:text-primary ">
                    2020
                </a>
                <a href="#" data-tab-toggle="#activity_2019"
                    className="btn btn-sm text-gray-600 hover:text-primary tab-active:bg-primary-light tab-active:text-primary ">
                    2019
                </a>
                <a href="#" data-tab-toggle="#activity_2018"
                    className="btn btn-sm text-gray-600 hover:text-primary tab-active:bg-primary-light tab-active:text-primary ">
                    2018
                </a>
                <a href="#" data-tab-toggle="#activity_2017"
