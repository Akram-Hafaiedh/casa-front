...
const Layout: React.FC = () => {
    ...
    const { ProjectId } = useParams<{ userId: string }>();
    const navigate = useNavigate();
    const [overviewUser, setOverviewUser] = useState<User>({
        id: '1',
        first_name: "John",
        last_name: "Doe",
                    ...
                    <div className="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10">
                        ...
                        <div className="flex items-center gap-1.5">
                            <div className="text-lg leading-5 font-semibold text-gray-900">
                                {overviewUser.first_name + " " + overviewUser.last_name}
                            </div>
                        ...
                        <div className="flex flex-wrap justify-center gap-1 lg:gap-4.5 text-sm">
                            ...
                            <div className="flex gap-1.25 items-center text-gray-600">
                                ...
                                <a href={`mailto:${overviewUser.email}`}
                                    target="_blank"
                    ...
                    <div className="grid">
                        <div className="overflow-x-auto">
                            <div className="menu gap-3">
                                <div className={`menu-item border-b-2 border-b-transparent menu-item-active:border-b-primary menu-item-here:border-b-primary ${location.pathname.includes('/overview') ? 'active show here' : ''}`}>
                                    <Link className="menu-link gap-1.5 pb-2 lg:pb-4 px-2" to={`/projects/${ProjectId}/overview`}>
                                ...
                                <div className={`menu-item border-b-2 border-b-transparent menu-item-active:border-b-primary menu-item-here:border-b-primary ${location.pathname.includes('/tasks') ? 'active show here' : ''}`}>
                                    <Link className="menu-link gap-1.5 pb-2 lg:pb-4 px-2" to={`/projects/${ProjectId}/tasks`}>
                                        <div className="menu-title text-nowrap font-medium  text-gray-700 menu-item-active:text-primary menu-item-active:font-semibold menu-item-here:text-primary menu-item-here:font-semibold menu-item-show:text-primary menu-link-hover:text-primary">
                                            Tasks
                                        </div>
                                    </Link>
                                </div>
                                <div className={`menu-item border-b-2 border-b-transparent menu-item-active:border-b-primary menu-item-here:border-b-primary ${location.pathname.includes('/budget') ? 'active show here' : ''}`}>
                                    <Link className="menu-link gap-1.5 pb-2 lg:pb-4 px-2" to={`/projects/${ProjectId}/budget`}>
                                ...
                                <div className={`menu-item border-b-2 border-b-transparent menu-item-active:border-b-primary menu-item-here:border-b-primary ${location.pathname.includes('/users') ? 'active show here' : ''}`}>
                                    <Link className="menu-link gap-1.5 pb-2 lg:pb-4 px-2" to={`/projects/${ProjectId}/users`}>
                                        <div className="menu-title text-nowrap font-medium  text-gray-700 menu-item-active:text-primary menu-item-active:font-semibold menu-item-here:text-primary menu-item-here:font-semibold menu-item-show:text-primary menu-link-hover:text-primary">
                                            Users
                                        </div>
                                    </Link>
                                </div>
                                <div className={`menu-item border-b-2 border-b-transparent menu-item-active:border-b-primary menu-item-here:border-b-primary ${location.pathname.includes('/files') ? 'active show here' : ''}`}>
                                    <Link className="menu-link gap-1.5 pb-2 lg:pb-4 px-2" to={`/projects/${ProjectId}/files`}>
                                        <div className="menu-title text-nowrap font-medium  text-gray-700 menu-item-active:text-primary menu-item-active:font-semibold menu-item-here:text-primary menu-item-here:font-semibold menu-item-show:text-primary menu-link-hover:text-primary">
                                            Files
                                        </div>
                                    </Link>
                                ...
                                <div className={`menu-item border-b-2 border-b-transparent menu-item-active:border-b-primary menu-item-here:border-b-primary ${location.pathname.includes('/activity') ? 'active show here' : ''}`}>
                                    <Link className="menu-link gap-1.5 pb-2 lg:pb-4 px-2" to={`/projects/${ProjectId}/activity`}>
                                        <div className="menu-title text-nowrap font-medium  text-gray-700 menu-item-active:text-primary menu-item-active:font-semibold menu-item-here:text-primary menu-item-here:font-semibold menu-item-show:text-primary menu-link-hover:text-primary">
                                            Activity
                                        </div>
                                    </Link>
                                </div>
                                <div className={`menu-item border-b-2 border-b-transparent menu-item-active:border-b-primary menu-item-here:border-b-primary ${location.pathname.includes('/settings') ? 'active show here' : ''}`}>
                                    <Link className="menu-link gap-1.5 pb-2 lg:pb-4 px-2" to={`/projects/${ProjectId}/settings`}>
                                        <div className="menu-title text-nowrap font-medium  text-gray-700 menu-item-active:text-primary menu-item-active:font-semibold menu-item-here:text-primary menu-item-here:font-semibold menu-item-show:text-primary menu-link-hover:text-primary">
                                            Settings
                                        </div>
                                    </Link>
